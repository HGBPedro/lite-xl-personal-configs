...
style.selection = { common.color "#024959" }
...
style.syntax["comment"] = { common.color "rgba(0, 0, 0, 0.75)" }
style.syntax["keyword"] = { common.color "#79878C" }
style.syntax["keyword2"] = { common.color "#bf616a" }
style.syntax["keyword3"] = { common.color "#03738C" }
